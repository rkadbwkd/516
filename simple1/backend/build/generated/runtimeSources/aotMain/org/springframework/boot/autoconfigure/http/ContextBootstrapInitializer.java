...
public final class ContextBootstrapInitializer {
  ...
  public static void registerGsonHttpMessageConvertersConfiguration(
      DefaultListableBeanFactory beanFactory) {
    BeanDefinitionRegistrar.of("org.springframework.boot.autoconfigure.http.GsonHttpMessageConvertersConfiguration", GsonHttpMessageConvertersConfiguration.class)
        .instanceSupplier(GsonHttpMessageConvertersConfiguration::new).register(beanFactory);
  }
}
